      ...
      <section className="bg-gradient-to-br from-blue-50 via-blue-100 to-blue-200 text-gray-800 py-20 pt-32">
        <div className="max-w-7xl mx-auto px-4 text-center">
          <h1 className="text-4xl lg:text-6xl font-bold mb-6">
            Sobre <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-600 to-purple-600">Equipotel</span>
          </h1>
          ...
          <Card className="bg-gradient-to-r from-blue-600 to-blue-700 text-white">
            <div className="grid grid-cols-1 md:grid-cols-4 gap-8 text-center">
              ...
              <div>
                ...
                <div className="text-blue-100">Instalaciones Realizadas</div>
              </div>
              <div>
